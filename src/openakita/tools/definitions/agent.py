...
AGENT_TOOLS = [
    {
        ...
        "description": (
            ...
            "with a delegation_id. Use check_delegation_status to poll, wait_for_delegations "
            "to block until completion, or cancel_delegation to stop. Set run_in_background=false "
            "for blocking mode (waits for result before returning).\n\n"
            "IMPORTANT:\n"
    ...
    },
    {
        ...
        "description": (
            ...
            "specialized for.\n\n"
            "**ASYNC BY DEFAULT**: Returns immediately with a batch_id. Use check_delegation_status "
            "to poll, wait_for_delegations to block until all complete, or cancel_delegation to stop. "
