...
import { AgentIcon, SVG_ICON_KEYS } from "../components/AgentIcon";
...
// SVG icon labels for the icon picker (paths come from shared AgentIcon module)
const SVG_ICON_LABELS: Record<string, string> = {
  terminal: "终端", code: "代码", globe: "全球", shield: "安全", database: "数据库",
  cpu: "芯片", cloud: "云", lock: "锁", zap: "闪电", eye: "监控", message: "对话",
  mail: "邮件", chart: "图表", network: "网络", target: "靶心", compass: "指南",
  layers: "层级", workflow: "流程", flask: "实验", pen: "创作", mic: "语音",
  bot: "机器人", puzzle: "拼图", heart: "爱心",
};
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8, marginTop: 4 }}>
                <span style={{ fontSize: 28, lineHeight: 1, display: "flex", alignItems: "center" }}>
                  <AgentIcon icon={agent.icon} size={28} color={agent.color || "currentColor"} />
                </span>
          ...
          <div className="flex flex-col gap-4 px-6 pb-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                >
                  <AgentIcon icon={editingProfile.icon} size={24} />
                </Button>
                {emojiPickerOpen && (
                      ...
                      {(ICON_CATEGORIES[iconCat]?.icons || []).map((iconVal) => {
                        ...
                        return (
                          <button
                            key={iconVal}
                            data-slot="skip"
                            title={isSvg ? (SVG_ICON_LABELS[iconVal.slice(4)] || iconVal.slice(4)) : undefined}
                            onClick={() => {
