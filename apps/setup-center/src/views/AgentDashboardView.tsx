...
import { AgentIcon, SVG_ICON_PATHS } from "../components/AgentIcon";
...
// SVG_ICON_PATHS imported from shared AgentIcon module (used by getSvgImage for canvas)
        ...
        <div className="neural-detail" onClick={(e) => e.stopPropagation()}>
          <div className="neural-detail-header" style={{ "--nc": selectedNode.color } as React.CSSProperties}>
            <span className="neural-detail-icon">
              <AgentIcon icon={selectedNode.icon} size={28} />
            </span>
            <div>
